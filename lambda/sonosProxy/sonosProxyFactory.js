...
sonosProxy.play = function(room) {
    var room = encodeURIComponent(room);
    var path = `/players/${room}/state`;
    var body = {
        playbackState: 'play'
    };

    console.log('calling play')
    return makeCall(path, 'PUT', body);
};
...
function makeCall(path, verb, body) {
    ...
    console.log(sonosProxy.baseUrl)
    ...
    return rp(request).then((data) => logCallSuccess(url, data), 
